...
const FacultyDashboard= React.lazy(() => import('./views/faculty/Home'))
const ClassAttendance= React.lazy(() => import('./views/faculty/Attendance'))
const TodayAttendance= React.lazy(() => import('./views/faculty/Attendance/today'))
const StudentDashboard= React.lazy(() => import('./views/students/Home'))
const Enroll= React.lazy(() => import('./views/students/Home/enroll'))
const Attendance= React.lazy(() => import('./views/students/Home/attendance'))
